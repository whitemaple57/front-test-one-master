      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            icon="el-icon-plus"
            size="mini"
            @click="handleAddTransportCompany"
          >
            新增
          </el-button>
        </el-col>
...
import { addtransportCompany } from "@/api/organization/residentEnterprise.js";
...
export default {
  ...
  methods: {
    ...
    handleAddTransportCompany() {
      // 构造请求参数
      const requestData = {
        companyAbbreviation: "good",
        companyCode: "B2023082800391",
        companyName: "变好",
        contacts: "hao",
        mobile: "18867898769",
        ...
        status: "0",
        telephone: null,
        userName: "18867898769"
      };

      // 调用新增运输公司的接口
      addtransportCompany(requestData)
        .then(response => {
          this.$message.success(response.msg);
        })
        .catch(error => {
          this.$message.error("新增运输公司失败：" + error.message);
        });
    }
  },
};
